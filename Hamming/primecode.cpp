...
// Version     : 0.2
// Copyright   : HammingCode @ KZ
// Description : Hamming Algorithm in C++, Ansi-style
//============================================================================
#include <cstdlib>
#include <iostream>
#include <string>
...
template<typename T> //shows up at using cout << [vector] << endl
...
struct TestFunctor {
    ...
    {
        if (stringIsBinary && !((ch == '0') || (ch == '1')))
            stringIsBinary = false;
    }
};
...
int main() {
    ...
    cout << "Hamming algorithm(7,4): " << endl;
    ...
    bitCode = generateRandom(8);
    //bitCode = "8";
    cout << "Generated bitCode: " << bitCode << endl;


    TestFunctor functor;
    for_each(bitCode.begin(), bitCode.end(), functor);
